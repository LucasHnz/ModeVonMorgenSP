...
public static void aktualisiereVorname(String vorname, String nutzernr){
	...
	public static void aktualisiereStraße(String straße, String nutzernr) {
...
public static void aktualisierePSS(int pss, String nutzernr) {
	...
	public static void neuerKunde(String nutzernr, String nachname, String vorname, String email, String straße, String ort, String plz, String iban, String berechtigung, String passwort, String pss){
		...
		try {
			...
			String sqlbefehl = "insert into Bestandskunde values ('"+nutzernr2+"','"+nachname+"','"+vorname+"','"+email+"','"+straße+"','"+ort+"','"+plz2+"','"+iban+"','"+berechtigung2+"','"+passwort+"','"+pss2+"')";
			
			stmt.executeQuery(sqlbefehl);
			
			Datenbankverwaltung.VerbindungDB.schließeVerbindung(con, stmt);
			BestandskundeSammlung.hinzufügenBestandskunde(nutzernr2, nachname, vorname, email, straße, ort, plz2, iban, berechtigung2, passwort,pss2);
