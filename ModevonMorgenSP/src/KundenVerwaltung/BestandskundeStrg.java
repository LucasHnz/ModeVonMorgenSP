...
public class BestandskundeStrg {
	...
	/**
	 * 
	 * F¸gt einen neuen Bestandskunden in die Datenbank ein
	 * @param nutzernr
	 ...
	 * @param straﬂe
	 *            Die Straﬂe in der der Kunde wohnt
	 * @param ort
	 ...
	 */
	public static void neuerKunde(int nutzernr, String nachname, String vorname, String email, String straﬂe,
		...
		try {
			...
			String sqlbefehl = "insert into Bestandskunde values ('" + nutzernr + "','" + nachname + "','" + vorname
					+ "','" + email + "','" + straﬂe + "','" + ort + "','" + plz + "','" + iban + "','" + berechtigung
					+ "','" + passwort + "','" + pss + "')";
			stmt.executeQuery(sqlbefehl);
			Datenbankverwaltung.VerbindungDB.schlieﬂeVerbindung(con, stmt);
			BestandskundeSammlung.hinzuf¸genBestandskunde(nutzernr, nachname, vorname, email, straﬂe, ort, plz, iban,
