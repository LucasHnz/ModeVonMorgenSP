...
public class GUIBestandskundeRegistrierung extends JPanel {
	...
	/**
	 * Registrierungsmaske f¸r Bestandskunden 
	 */
	public GUIBestandskundeRegistrierung() {
		...
		/**
		 * Button Registrieren f¸gt den neuen Kunden zu der Datenbank hinzu
		 */
		...
		btnRegistrieren.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				KundenVerwaltung.BestandskundeStrg.neuerKunde(nutzernr, nachname, vorname, email, straﬂe, ort, plz,
						iban, berechtigung, passwort, pss);

				JOptionPane.showOptionDialog(null, "Sie wurden registriert! ", "Registrierung",
						JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE, null, new String[] { "Ok" },
						"Ok");

				MailController.MailSenden.sendMail(email, "Best‰tigung ihrer Registrierung",
						"Sehr geehrter Kunde, Vielen Dank f¸r ihre Registrierung. Viel Spaﬂ beim Einkaufen! ");
