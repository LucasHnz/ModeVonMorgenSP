...
public class GUIMitarbeiter implements ActionListener{
	...
	private void initialize(String[]damenCbList, String[]herrenCbList, String[]anmeldenCbList) {
		...
		btnZur�ck.setBounds(10, 8, 89, 35);
		panelBar.add(btnZur�ck);
	...
	public void anzeigenArtikel() {
		...
		JLabel lblGroe�e = new JLabel("Gr��e: 34");
		lblGroe�e.setBounds(167, 50, 78, 32);
		lblGroe�e.setFont(new Font("Lucida Bright", Font.BOLD, 15));
		panel.add(lblGroe�e);
